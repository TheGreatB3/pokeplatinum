...
static BOOL ov6_0224222C(UnkStruct_02073C74 * param0, const UnkStruct_ov6_022422D0 * param1, const UnkStruct_ov6_0224222C * param2, const u8 param3, const u8 param4, const u8 param5, u8 * param6);
static BOOL ov6_022422D0(const UnkStruct_ov6_022422D0 * param0, UnkStruct_02073C74 * param1, const u8 param2);
...
static BOOL ov6_02241674(UnkStruct_0203CDB0 * param0, UnkStruct_02073C74 * param1, UnkStruct_ov6_02240D5C * param2, UnkStruct_ov6_02242634 * param3, UnkStruct_ov6_0224222C * param4, const UnkStruct_ov6_022422D0 * param5, const UnkStruct_ov6_02241674 * param6);
static BOOL ov6_0224174C(UnkStruct_0203CDB0 * param0, UnkStruct_02073C74 * param1, UnkStruct_ov6_02240D5C * param2, UnkStruct_ov6_0224222C * param3, const UnkStruct_ov6_022422D0 * param4);
static BOOL ov6_02241790(UnkStruct_0203CDB0 * param0, UnkStruct_02073C74 * param1, UnkStruct_ov6_02240D5C * param2, UnkStruct_ov6_0224222C * param3, const UnkStruct_ov6_022422D0 * param4);
static BOOL ov6_022417AC(UnkStruct_0203CDB0 * param0, UnkStruct_02073C74 * param1, UnkStruct_ov6_02240D5C * param2, UnkStruct_ov6_0224222C * param3, const UnkStruct_ov6_022422D0 * param4, const int param5);
...
static BOOL ov6_02241F7C(UnkStruct_0203CDB0 * param0, UnkStruct_02073C74 * param1, const UnkStruct_ov6_022422D0 * param2, const UnkStruct_ov6_0224222C * param3, const int param4, UnkStruct_ov6_02240D5C * param5, const int param6, const int param7);
static BOOL ov6_02241F2C(const int param0, const int param1, const int param2, const BOOL param3, const u32 param4, const UnkStruct_ov6_022422D0 * param5, UnkStruct_02073C74 * param6, UnkStruct_ov6_02240D5C * param7);
static u8 ov6_0224226C(const BOOL param0, const u8 param1, const UnkStruct_ov6_022422D0 * param2, const u32 param3, UnkStruct_02073C74 * param4);
...
static BOOL ov6_02242514(const int param0, const UnkStruct_ov6_022422D0 * param1, UnkStruct_02073C74 * param2, UnkStruct_ov6_02240D5C * param3);
static u8 ov6_022425D4(const UnkStruct_ov6_0224222C * param0, const UnkStruct_ov6_022422D0 * param1, const u8 param2);
static void ov6_02242634(UnkStruct_0203CDB0 * param0, UnkStruct_02073C74 * param1, UnkStruct_ov6_02242634 * param2, UnkStruct_ov6_022422D0 * param3);
static void ov6_02241A90(UnkStruct_02073C74 * param0, u8 * param1);
...
BOOL ov6_022411C8 (UnkStruct_0203CDB0 * param0, UnkStruct_020508D4 * param1)
{
    ...
    v10 = sub_0207A268(param0->unk_0C);
    v11 = (UnkStruct_ov6_02242634 *)sub_0203A640(param0);
    v1 = sub_0207A0FC(v10, 0);
...

    {
...

        {
            if (!sub_0202D9D8(sub_0202D834(param0->unk_0C))) {
                ...
                v13.unk_04 = 1;
                v13.unk_0C = sub_02074470(v15, 161, NULL);
            }
        }
...
static u8 ov6_02241AE4 (UnkStruct_02073C74 * param0, const UnkStruct_ov6_022422D0 * param1)
{
    u32 v0;
    ...
    if (param1->unk_0D == 0) {
        if (param1->unk_0E == 28) {
            if (inline_020564D0(2) == 0) {
                v0 = (u32)sub_02074470(param0, 0, NULL);
                v0 = v0 % 25;
                return (u8)v0;
            }
        }
...
static void ov6_02241BAC (const u16 param0, const u8 param1, const int param2, const u32 param3, const UnkStruct_ov6_022422D0 * param4, UnkStruct_02073C74 * param5, UnkStruct_ov6_02240D5C * param6)
{
    BOOL v0;
    u32 v1;
    BOOL v2;
        ...
        if (param4->unk_0E == 56) {
            ...
            default:
                if (inline_020564D0(3) > 0) {
                    v3 = sub_02074470(param5, 111, NULL);
                    v2 = 1;
                }
            }
...
static void ov6_02241CC0 (u16 param0, u8 param1, const int param2, const UnkStruct_ov6_022422D0 * param3, UnkStruct_02073C74 * param4, UnkStruct_ov6_02240D5C * param5)
{
    ...
    if (v0) {
        if (param3->unk_0D == 0) {
            if (param3->unk_0E == 56) {
                if (inline_020564D0(3) > 0) {
                    v1 = sub_02074470(param4, 111, NULL);
...
void ov6_022420D4 (UnkStruct_0203CDB0 * param0, u16 param1, u8 param2, UnkStruct_ov6_02240D5C * param3)
{
...

    {
        ...
        v2 = sub_0207A268(param0->unk_0C);
        v0 = sub_0207A0FC(v2, 0);
...
static BOOL ov6_022422D0 (const UnkStruct_ov6_022422D0 * param0, UnkStruct_02073C74 * param1, const u8 param2)
{
    ...
    if (param0->unk_0D == 0) {
        if ((param0->unk_0E == 51) || (param0->unk_0E == 22)) {
            v0 = sub_02074470(param1, 161, NULL);
...
static BOOL ov6_02242514 (const int param0, const UnkStruct_ov6_022422D0 * param1, UnkStruct_02073C74 * param2, UnkStruct_ov6_02240D5C * param3)
{
    ...
    return sub_0207A048(param3->unk_04[param0], param2);
}
...
static void ov6_02242634 (UnkStruct_0203CDB0 * param0, UnkStruct_02073C74 * param1, UnkStruct_ov6_02242634 * param2, UnkStruct_ov6_022422D0 * param3)
{
    if (sub_02074470(param1, 76, NULL) == 0) {
        param3->unk_0D = 0;
        param3->unk_0E = sub_02074470(param1, 10, NULL);
    } else {
        param3->unk_0D = 1;
        param3->unk_0E = 123;
    }
